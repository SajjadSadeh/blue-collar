<template>
  <div class="flex flex-col gap-20">
    <!-- hero -->
    <div
      class="relative flex flex-col items-start justify-center w-full px-4 mx-auto max-w-[2500px]"
      :style="{ height: height + 'px' }"
    >
      <img
        class="absolute inset-0 w-full -z-10"
        src="https://rerjviduejgewfzshqms.supabase.co/storage/v1/object/sign/images/home-page-hero.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJpbWFnZXMvaG9tZS1wYWdlLWhlcm8uanBnIiwiaWF0IjoxNjk2NjAzNzMxLCJleHAiOjMzMjMyNjAzNzMxfQ.zFE6whzs1BVEiPRtx-i5r_O6vKTFZI52ruOljNtLYXo&t=2023-10-06T14%3A48%3A51.393Z"
        alt=""
        ref="image"
      />
      <Container>
        <div class="flex flex-col items-start gap-8">
          ...
          <h1
            class="sm:text-3xl text-2xl lg:text-5xl font-bold text-white max-w-[19rem] sm:max-w-[35rem]"
          >
            We Are Professional Quality Services
          </h1>
          <NuxtLink
            to="/services"
            class="px-2 py-1 text-sm font-medium sm:px-4 sm:text-base sm:py-2 bg-myOrange text-myBlue"
          >
            Our Services
          </NuxtLink>
        </div>
    ...
    <div>
      ...
      >
        ...
        <TitleCustom text="We Provide Your Future" />
        <p class="text-myGray">
          ...
          tincidunt. Interdum et malesuada. In pulvinar viverra diam, nec rutrum
          mauris maximus non. Aenean sed quam tristique, facilisis est ac,
          interdum velit.
        </p>
        <div class="flex items-center gap-8">
          <div
            class="flex flex-col items-center justify-center bg-myWhite max-w-[100px] py-3"
          >
            <p class="text-5xl font-black text-myOrange">35</p>
            <p class="text-lg font-bold text-center text-myBlue">
              Years Of Experiance
            </p>
          </div>
          <div class="text-myGray">
